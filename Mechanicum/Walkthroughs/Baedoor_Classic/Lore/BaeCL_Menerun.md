...
<table>
  <!--PHOTO 1-->
  <tr>
    <td width="420" rowspan="2"><img alt="Jitado Archives, Photo 1" height="307" src="/Assets/Sources/L_007_Jitado/arv_jitado_1.jpg" width="416"/></td>
    <th align="centre">Menerun Gates</th>
  </tr>
  <tr>
    <td>
      First page shows entrance to Menerun, Jitado's first and biggest city showcased in this notebook.<br>
      It begins with Evrun street immediately and we can see Silas' Tavern being shown.<br>
      Appearance of citizen makes Menerun look quite lively and cosmopolitan, showcasing ghloddish,
      mesinpean and jitadish fashion, which is true.<br>
      Same holds for pretty well shown architecture:
      the only case to point out is that walls to Menerun would most likely not be out of wood and
      have barbarian style which stands out even in current context.
    </td>
  </tr>
...
---
### Lore accuracy
What is pretty surprising about `L.007` is lore coherency. While character names tend to be
a bit too random (or rather, visibly inspired by games I played at the time),
names of cities and general shapes of architecture tend to be rather closer to what current
image of Jitado says.  
Since the country didn't change *that* much over the years, it basically means the notebook could
be easily placed in any timespan and not be too odd for lore coherency.  
But since I do want to give myself a bit of freedom, let's say that it will take place in either
late PE or early OE, so I can shape late OE/NE Jitado later, if there's any need to emphasize
obvious technological advancements.  
...
Notebook source: [**L.007:Jitado**](/Mechanicum/Walkthroughs/Baedoor_Classic/Sources/L_007_Jitado.md)
