...
<table>
  ...
  <tr>
    <td>
      Showcases beginning of the forest with some <i>spectre nosfer</i> floating nearby 
      (originally as <i>latawiec</i>, but since it doesn't look like dermopteran/colugo, 
      <i>zębowiec</i> seem more fitting, and with no good translation to English, <i>nosfer</i> was 
      chosen to make subtle link to vampire, but not in stereotypical way).<br>
      Some mystical runestone is standing here, making connection to stones seen in Dvickhet.
    </td>
  </tr>
  <!--PHOTO 2-->
  <tr>
  ...
  <tr>
    <td>
      This is final panel of the notebook, at least from those depicting lands of Baedoor.<br>
      As such, it doesn't have anything drawn but some trees and meadow.
    </td>
  </tr>
</table>
