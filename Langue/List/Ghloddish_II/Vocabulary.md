...
---
## Changes
Between **First Era** and **Second Era**, some elements of the language changed. Most notably:
...
|   a'ar'e'   | poem                        | aa:r:e:       | a'-ar'-e'         |                                                                higher form of `ar'e'`                                                                 |
|  a'ar'ne'   | book                        | aa:r:ne:      | a'-ar'-n-e'       |                                                                higher form of `ar'ne'`                                                                |
|    a'oe'    | highland                    | a:e:          | a'-oe'            |                                                                       a' + oe'                                                                        |
|     a'r     | power, magical power        | a:r           | a'-r              |                                                          got shortened from previous "ah'r"                                                           |
...
|    ar'e'    | word                        | arre:         | ar'-e'            |                                                                           -                                                                           |
|   ar'ne'    | letter (symbol)             | arrne:        | ar'-n-e'          |                                                                           -                                                                           |
...
| ta'resh'aur | night (moon journey)        | taareshhaur   | ta-ar-e-sh'-a-u-r |                                                                    ta'r'oesh + aur                                                                    |
| ta'resh'sur | day (sun journey)           | taareshhsur   | ta-ar-e-sh'-s-u-r |                                                                    ta'r'oesh + sur                                                                    |
...
|            night            | ta'resh'aur  | taarroeshhaur | ta-ar-e-sh'-a-u-r |
