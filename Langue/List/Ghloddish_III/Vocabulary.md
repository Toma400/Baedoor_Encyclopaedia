...
- [Changes](Vocabulary.md#changes)
- [Ghloddish → English](Vocabulary.md#ghloddish--english)
- [English → Ghloddish](Vocabulary.md#english--ghloddish)
- [Non-translative Words](Vocabulary.md#non-translative-words)

---
## Changes
Between **Second Era** and **Third Era**, some elements of the language changed. Most notably:
- Several shortenings of words, making it more melodic (as in `a'ar'e'` becoming `a'are'`)
...
|   a'ane'   | book                        | a:ane:        | a'-a-n-e'      |                                                          melodified from previous `a'an'e'`                                                           |
|   a'are'   | poem                        | a:are:        | a'-ar-e'       |                                                          melodified from previous `a'ar'e'`                                                           |
|   a'ne'    | letter (symbol)             | a:ne:         | a'-n-e'        |                                                           shortened from previous "ar'ne'"                                                            |
|   a'oe'    | highland                    | a:e:          | a'-oe'         |                                                                       a' + oe'                                                                        |
|    a'r     | power, magical power        | a:r           | a'-r           |                                                                           -                                                                           |
|   a'she    | woman                       | a:she         | a'-sh-e        |                                                          a' + she (feminine prefix + being)                                                           |
|    a'y'    | lady                        | a:ij          | a'-y'          |                                                                        a' + y'                                                                        |
...
|  ta'hrghe  | alike, close to heart       | taahrkhe      | ta-ah-r-gh-e   |                                                                      ta'hr + ghe                                                                      |
|  ta'hroe'  | fatherland                  | taahroe:      | ta-ah-r-oe'    |                                                                      ta'hr + oe'                                                                      |
|  ta'hrshe  | close person, friend        | taahrshe      | ta-ah-r-sh-e   |                                                                      ta'hr + she                                                                      |
|    ta'r    | rock, stone                 | taar          | ta-ar          |                                                                           -                                                                           |
|  ta'r'a'   | to go                       | taarra:       | ta-ar'-a'      |                                                    from `ta'r`, literally "to go on top of a rock"                                                    |
| ta'r'a'er  | to cross                    | taarra:er     | ta-ar'-a'-e-r  |                                                                     ta'r'a' + er                                                                      |
| ta'r'a'she | wanderer, traveller         | taarra:she    | ta-ar'-a'-sh-e |                                                                     ta'r'a' + she                                                                     |
|  ta'r'oe   | road                        | taarroe       | ta-ar'-oe      |                                                         either from `ta'r` or `ta'r'a'` + oe'                                                         |
| ta'r'oeghe | to get to know (yourself)   | taarroekhe    | ta-ar'-oe-gh-e |                        ta'r'oe + ghe, from idea that understanding yourself wholely is process, just as "travelling the road"                         |
| ta'r'oeoe' | to get to know (location)   | taarroeoe     | ta-ar'-oe-oe'  |         ta'r'oe + oe', as you need to wander to get somewhere (word means both encountering the place, as well as getting to know it deeply)          |
| ta'r'oesh  | journey                     | taarroesh     | ta-ar'-oe-sh   |                                                             ta'r'oe + most probably `sh'`                                                             |
...
|   ta'shr   | cover, disguise             | taashr        | t-a'-sh-r      |                                 may be related that hiding is art of disappearing, "inside" may have such connections                                 |
| ta'shrghe  | shadow                      | taashrkhe     | t-a'-sh-r-gh-e |                                                                     ta'shr + ghe                                                                      |
|  ta'shroa  | (to) hide                   | taashr oa     | ta'-sh-r-oa    |                                                         ta'shr + -oa suffix common for verbs                                                          |
|  tar'aur   | night (moon journey)        | tar:aur       | t-ar'-a-u-r    |                                                                    ta'r'oesh + aur                                                                    |
|  tar'sur   | day (sun journey)           | tar:sur       | t-ar'-s-u-r    |                                                                    ta'r'oesh + sur                                                                    |
|    thar    | yes                         | thar          | th-ar          |                                                                           -                                                                           |
|  the're'   | destruction, extinction     | the:re:       | th-e'-r-e'     |                                                       became more flowing from II Era `th're'`                                                        |
|     y'     | guide, master               | ij            | y'             |                                                                   from I era `e'e`                                                                    |

---
## English → Ghloddish
[Pronunciation Helper](/Langue/Pronunciation.md) ✤ For etymology, look at [higher section](Vocabulary.md#ghloddish--english) ⚜️ [Phonetic Rules](Phonetics.md)

|            Word             | Translation  | Pronunciation | Letters        |
|:---------------------------:|--------------|---------------|----------------|
|            alike            | ta'hrghe     | taahrkhe      | ta-ah-r-gh-e   |
|            alive            | ne'se        | ne:se         | n-e'-s-e       |
|             and             | s'           | s:            | s'             |
 |           (to) be           | ara          | ara           | a-r-a          |
|        (to) be made         | gh'          | khh           | gh'            |
|      (to) become alive      | gh'          | khh           | gh'            |
|        the beginning        | sh'          | shh           | sh'            | 
|            being            | she          | she           | sh-e           |
|            book             | a'ane'       | aa:ne:        | a'-n-e'        |
|           border            | er           | er            | e-r            |
|           bottom            | e'ana        | e:ana         | e'-a-n-a       |
|        close person         | ta'hrshe     | taahrshe      | ta-ah-r-sh-e   |
|       close to heart        | ta'hrghe     | taahrkhe      | ta-ah-r-gh-e   |
|            cover            | ta'shr       | taashr        | t-a'-sh-r      |
|         (to) cross          | ta'r'a'er    | taarra:er     | ta-ar'-a'-e-r  |
|   day (opposed to night)    | tar'sur      | tar:sur       | t-ar-s-u-r     |
|            dead             | se'          | se:           | s-e'           |
|         destination         | ana          | ana           | a-n-a          |
|         destruction         | the're'      | the:re:       | th-e'-r-e'     |
|          disguise           | ta'shr       | taashr        | t-a'-sh-r      |
|            down             | e'ana        | e:ana         | e'-a-n-a       |
|           entity            | she          | she           | sh-e           |
|         extinction          | the're'      | the:re:       | th-e'-r-e'     |
...
|            night            | tar'aur      | tar:aur       | t-ar-a-u-r     |
|            poem             | a'are'       | aa:re:        | a'-ar-e'       |
|            power            | a'r          | a:r           | a'-r           |
|            road             | ta'r'oe      | taarroe       | ta-ar'-oe      |
|            rock             | ta'r         | taar          | ta-ar          |
|            root             | ethr         | e:thr         | e-th-r         |
|           shadow            | ta'shrghe    | taashrkhe     | t-a'-sh-r-gh-e |
|            soul             | ghe          | khe           | gh-e           |
|           spirit            | ghe          | khe           | gh-e           |
