...
---
## Changes
- There are some melody extending words, usually coming from trish languages (as in `y' → y'ya`)
...
|            lady             | a'ya         | a:ijja        | a'-ya          |
|            land             | oe'          | oe:           | oe'            |
|       letter (symbol)       | a'ne'        | a:ne:         | a'-n-e'        |
|            lord             | s'ya         | ssijja        | s'-ya          |
|            lower            | e'- (prefix) | e:            | e'             |
|             man             | s'she        | s:she         | s'-sh-e        |
|          masculine          | s'- (prefix) | s:            | s'             |
|           master            | y'ya         | ijja          | y'-ya          |
 |             me              | asa'         | asa:          | a-s-a'         |
|            moon             | aur          | aur           | a-u-r          |
