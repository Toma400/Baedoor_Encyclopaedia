# ⛩️ Trish
Tri (or trish, trianish) language is one of the oldest and yet, the most broadly used language in Baedoor universe.  
Unlike others, though, it relies on so many dialects and variants that it is difficult to really
capture its "universal essence", although some attempts are made under "general trish" name.

### Trish history
[complete this boi]

<center><b>Trish evolution tree</b></center>

```
Ghloddish (I era) → Starshimmering language    Modern
                          ↗                    zhian   Eitric
                         |                           ↖    ↑
   Northic trish    Magic trish    Old middle trish    Zhian   Tribal south trish   Ancient voitrianish
        |          ↙     |      ↘          |         ↙                |        ↘ ↙           |
        ↓        ↙       ↓        ↘        ↓       ↙                  ↓        ↙ ↘           ↓          ╔═════════════════════╗
Middle-era north  ╔══════════════╗    Middle-era                   Ancient   <─┘   └─>   Middle-era  ->  ║ Voitrianish dialect ║
  coast trish     ║Mountain trish║   middle trish                south trish             voitrianish     ╚═════════════════════╝
        |         ║  (dialect)   ║      ↓                     ↙       |   ╔═════════╗        |
        ↓         ╚══════════════╝ ╔════════╗               ↙         ├─> ║ Pahtric ║        ↓
    ╔════════╗                     ║ Valley ║      Middle-era         ↓   ╚═════════╝  ╔═════════════╗
    ║ North  ║                     ║ trish  ║     south trish    Old saphtric          ║  Rossevette ║
    ║ trish  ║                  ↙  ╚════════╝   ↙                     ↓                ║ voitrianish ║
    ╚════════╝                ↙               ↙               ╔═════════════════╗      ╚═════════════╝
        |                   ↙       ╔══════════════╗          ║ Modern saphtric ║               |
        |                 ↙         ║    Modern    ║          ╚═════════════════╝               |
